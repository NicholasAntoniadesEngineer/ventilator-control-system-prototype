...
// Set up variables
int BPMmax = 100;
int motorStepsPerRev = 810; // 1/8 steps micro stepping
int gearRatio = 4;

// Make this based on input volume and control
int pauseDelayms = 15000;
int plateuDelayms = 7270;  // Updated this based on a function of bpm
int uartFrequency = 4;
